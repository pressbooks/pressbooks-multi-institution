 ...
 */function*Ot(o,t){if(o!==void 0){let e=0;for(const s of o)yield t(s,e++)}}class Ct extends O{static get styles(){return lt`
    ...
    `}static get properties(){return{htmlId:{type:String},disabled:{type:Boolean},max:{type:Number},label:{type:String},hint:{type:String},activeIndex:{type:Number},value:{type:String},open:{type:Boolean},groups:{type:Array},options:{type:Object},selectedOptions:{type:Array},filteredOptions:{type:Object},MenuActions:{type:Object},Keys:{type:Object}}}constructor(){super(),this.max=0,this.htmlId="",this.activeIndex=0,this.value="",this.open=!1,this.groups=[],this.options={},this.selectedOptions=[],this.filteredOptions={},this.MenuActions={Close:"Close",CloseSelect:"CloseSelect",First:"First",Last:"Last",Next:"Next",Open:"Open",PageDown:"PageDown",PageUp:"PageUp",Previous:"Previous",Select:"Select",Space:"Space",Type:"Type"},this.Keys={Backspace:"Backspace",Clear:"Clear",Down:"ArrowDown",End:"End",Enter:"Enter",Escape:"Escape",Home:"Home",Left:"ArrowLeft",PageDown:"PageDown",PageUp:"PageUp",Right:"ArrowRight",Space:" ",Tab:"Tab",Up:"ArrowUp"}}get _label(){return this.shadowRoot.querySelector("slot").assignedElements().filter(e=>e.matches("label"))[0]}get _select(){return this.shadowRoot.querySelector("slot").assignedElements().filter(e=>e.matches("select[multiple]"))[0]}get _hint(){const t=this.shadowRoot.querySelector("slot");if(this._select.getAttribute("aria-describedby")){const e=this._select.getAttribute("aria-describedby");return t.assignedElements().filter(s=>s.matches(`#${e}`))[0]}return!1}get _selectionLessThanMax(){return this.max>0?this.selectedOptions.length<this.max:!0}selectionsTemplate(){return b` <span id="${this.htmlId}-remove" hidden>remove</span>
...
//# sourceMappingURL=multiselect-404a82b1.js.map
