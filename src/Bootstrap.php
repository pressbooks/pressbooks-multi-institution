...
final class Bootstrap
{
    ...
    private function registerActions(): void
    {
        ...
        add_action('network_admin_menu', fn () => app(ManagerPermissions::class)->modifyAdminBarMenus(), 1000);
        add_action('admin_menu', fn () => app(ManagerPermissions::class)->modifyAdminBarMenus(), 1000);
