...
document.addEventListener('DOMContentLoaded', function() {
	document.querySelector('#pressbooks-multi-institution-assign-users #bulk-action-selector-top')
		.firstElementChild.textContent = Custom.defaultOptionText;
	...
	document.querySelector('#pressbooks-multi-institution-assign-users #doaction')
		.addEventListener('click', function(e) {
			...
			if (action !== '-1' && items.length > 0 && confirm(Custom.text)) {
